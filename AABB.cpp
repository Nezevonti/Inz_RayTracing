...
bool AABB::intersect(const Ray& ray, Vec3& intersectionPoint, AABB_Face& intersectionFace, float& tmin, float& tmax) const {
    ...
    float tmin_direction[3];
    float tmax_direction[3];
    float *tmin_overall = &tmin;
    float *tmax_overall = &tmax;
